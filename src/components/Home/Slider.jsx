          ...
          return (
            <SwiperSlide key={i}>
              <div>
                ...
                <div class="mt-8 mb-16 xs-max:mt-14 dark:text-hadith-deepoffwhite xs-max:mb-14 font-medium opacity-90 leading-7 xss:mt-2 xs:mt-6 sm:text-lg md:text-lg lg:text-xl xl-min:text-xl">
