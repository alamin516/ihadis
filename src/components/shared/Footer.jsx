...
const Footer = () => {
  return (
    <div className="lg:w-11/12 mx-auto pb-10 mt-12 xss:max-w-full xs:max-w-full sm:max-w-full md:px-6 md:w-full">
      <div className="flex items-center xs-max:w-full gap-3 pt-10 mb-5 xss:mb-4 xss:w-14 xss:h-14 xss:pt-0 sm:mt-10">
        <img className="w-10" src="/images/home-logo.png" alt="hadith-logo" />
        <h1 className="text-[1.7rem] font-medium text-hadith-logo-color">
          আল হাদিস
        </h1>
      </div>
      <div className="grid w-full gap-4 xss:grid-cols-2 xs:grid-cols-2 md-max:gap-y-7 lg:grid-cols-6">
        <div className="xss:col-span-2 xs:col-span-2 sm:col-span-3 sm:w-full md:col-span-full lg:col-span-2 lg:pr-[93px] pr-0">
        ...
        <div className="grid lg:grid-cols-3 lg:col-span-4 gap-10">
